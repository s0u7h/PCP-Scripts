...
-- Project / Clip should be selected in the Media Explorer before activating this script. Load script separately in Media Explorer context. 
-- Requires recentish REAPER (6.52ish?), SWS, JS_ReaScriptAPI and ReaPack with the me2beats repo installed: https://github.com/me2beats/reapack/raw/master/index.xml
